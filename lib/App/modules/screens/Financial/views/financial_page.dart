                ...
                child: Column(
                  children: [
                    ListTile(
                      ...
                      trailing: TextButton(
                        onPressed: () {
                          Get.toNamed(RouteNames.changeFinancialInfo, arguments: controller.bankingInfoDataModel);
                        },
                        child: Text('Change'),
                      ),
                    ),
                        ...
                        child: Column(
                          children: [
                            ListTile(
                              ...
                              trailing: Text(
                                '${FinancialController.bankingInfoDataModel.client!.banking?.bankName}',
                                style: TextStyle(
                                  color: Colors.black,
                            ...
                            ListTile(
                              iconColor: Colors.black,
                              trailing: Text(
                                '${FinancialController.bankingInfoDataModel.client!.banking?.branchName}',
                                style: TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.w600,
                                  fontSize: 15,
                            ...
                            ListTile(
                              iconColor: Colors.black,
                              trailing: Text(
                                '${FinancialController.bankingInfoDataModel.client!.banking?.acName}',
                                style: TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.w600,
                                  fontSize: 15,
                            ...
                            ListTile(
                              iconColor: Colors.black,
                              trailing: Text(
                                '${FinancialController.bankingInfoDataModel.client!.banking?.acNo}',
                                style: TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.w600,
                                  fontSize: 15,
