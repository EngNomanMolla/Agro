...
class _MobileBankingState extends State<MobileBanking> {
  MobileBankingController mobileBankingController =
      Get.put(MobileBankingController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: GetBuilder<MobileBankingController>(
          builder: (MobileBankingController) {
        return MobileBankingController.getpersonInfoProgress
            ...
            : RefreshIndicator(
                ...
                child: Column(
                  children: [
                    ListTile(
                      title: Text('Mobile Banking Informaion',
                        ...
                        child: Column(
                          children: [
                            ListTile(
                              ...
                              trailing: Text(
                                ' ${MobileBankingController.personInfoDataModel.client!.mfs?.mfsName}',
                                style: TextStyle(
                                  color: Colors.black,
                            ...
                            ListTile(
                              iconColor: Colors.black,
                              trailing: Text(
                                ' ${MobileBankingController.personInfoDataModel.client!.mfs?.mfsType}',
                                style: TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.w600,
                                  fontSize: 15,
                            ...
                            ListTile(
                              iconColor: Colors.black,
                              trailing: Text(
                                '${MobileBankingController.personInfoDataModel.client!.mfs?.mfsNumber}',
                                style: TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.w600,
                                  fontSize: 15,
