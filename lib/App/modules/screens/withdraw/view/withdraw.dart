          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('\$${controller.personInfoDataModel.client!.allBalance!.restBalance}',
                      style: TextStyle(
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                height: 50,
                                decoration: BoxDecoration(
                                    color: controller.selected != null && controller.selected!.value == 0
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                height: 50,
                                decoration: BoxDecoration(
                                    color: controller.selected != null && controller.selected!.value == 1
                                        ? Color(0xff38b579).withOpacity(.050)
                                        : null,
                                    border: Border.all(
                                      color: controller.selected != null && controller.selected!.value == 1
                      ...
                      Column(
                        ...
                        children: controller.selected == null
                          ...
                          AppTextFieldWidget(
                            ...
                            hintText: '${controller.personInfoDataModel
                                .client!.banking!.bankName}',
                          ),
                          const SizedBox(
                            height: 10,
                          ),
              ...
              Obx(() => AppElevatedButton(
                ...
                child: Text(
                  controller.isLoading.value ? 'Requesting...' : "Withdraw Now",
