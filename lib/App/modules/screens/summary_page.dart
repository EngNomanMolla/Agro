                ...
                Padding(
                  ...
                  child: Table(
                    ...
                    children: [
                      ...
                      _buildTableRow('Product Type', widget.project.categoryName!),
                      _buildTableRow('Project Duration', widget.project.duration),
                      _buildTableRow('Starting Date', widget.project.startDate  ?? ''),
                      _buildTableRow('Ending Date', widget.project.expirationDate  ?? ''),
